...
const (
	Post_ListPostsByUserId_FullMethodName = "/v1.post.Post/ListPostsByUserId"
	Post_ListPosts_FullMethodName         = "/v1.post.Post/ListPosts"
)
...
func (c *postClient) ListPostsByUserId(ctx context.Context, in *ListPostsByUserIdRequest, opts ...grpc.CallOption) (*ListPostsByUserIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, Post_ListPostsByUserId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Post_ListPostsByUserId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Post_ListPostsByUserId_FullMethodName,
	}
