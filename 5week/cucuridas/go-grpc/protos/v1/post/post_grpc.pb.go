...
type PostClient interface {
	ListPostsByUserId(ctx context.Context, in *ListPostByUserIdRequest, opts ...grpc.CallOption) (*ListPostsByUserIdResponse, error)
...
func (c *postClient) ListPostsByUserId(ctx context.Context, in *ListPostByUserIdRequest, opts ...grpc.CallOption) (*ListPostsByUserIdResponse, error) {
...
type PostServer interface {
	ListPostsByUserId(context.Context, *ListPostByUserIdRequest) (*ListPostsByUserIdResponse, error)
...
func (UnimplementedPostServer) ListPostsByUserId(context.Context, *ListPostByUserIdRequest) (*ListPostsByUserIdResponse, error) {
...
func _Post_ListPostsByUserId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServer).ListPostsByUserId(ctx, req.(*ListPostByUserIdRequest))
	}
